...
<div id="sub" class="my-cinema">
	<section>
		...
		<div class="my-info">
			...
			<h2>
				<span class="name"><em>${member.user_id}</em>님 환영합니다!</span> 
				...
				<div class="tab1">
					...
					<div class="pay-attention">
						...
						<p>
							...
							&nbsp;&nbsp;<em>- 모바일캐시비/티머니(후불형): 취소금액은 환불되지 않고, 신용카드 대금에서 청구 취소됩니다. 
							(취소일 7일 이내 카드사 청구내역에서 확인 가능합니다.)</em><br> 
							&nbsp;&nbsp;- 모바일캐시비/티머니(플라스틱카드): 교통카드충전결제 APP 실행 후, [환불내역]에서 카드 태깅하여 카드로 충전됩니다.<br> 
							
							<span>[예매취소 안내]</span><br> 
							·&nbsp;<em>온라인 예매 취소는 상영 20분 전까지 가능하며, 20분 이전부터는 현장 취소만 가능합니다.
							(단, 무대인사 취소는 영화 시작 24시간 전 까지만 가능합니다.)</em><br>
