...
<head>
    ...
    <script src="${path}/admin/js/selectMenu.js"></script>
    <script src="${path}/admin/js/searchMoviePopup.js"></script>
...
<body>
    <div id="wrapper-admin">
        <header>
            <div class="container">
                <a class="logo" href="${path}/admin/index"><img src="${path}/admin/img/admin_logo.png" alt=""></a>
            </div>
        </header>
        <div>
            <div class="container">
