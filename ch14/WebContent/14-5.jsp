...
<%
	...
	if(rs.next()){
		...
		mb.setName(rs.getNString(2));
		mb.setHp(rs.getNString(3));
		mb.setPos(rs.getNString(4));
...
<body>
	...
	<form action="./14-6.jsp" method="get">
		 <table border="1">
			...
			<tr>
				<td>입사일</td>
				<td><input type="date" name="rdate" readonly="readonly" value="<%= mb.getRdate().substring(2,10) %>"></td>
			</tr>
			<tr>
